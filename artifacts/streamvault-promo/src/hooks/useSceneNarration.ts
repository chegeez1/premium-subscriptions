...
export const SCENE_SCRIPTS: Record<string, string> = {
  ...
  cardTools: "Shorten any link instantly with click analytics. Generate Luhn-valid cards by BIN. Check card format and expiry. Look up any BIN — bank, country, tier, and 3D Secure status in one hit. ChegeTech has every tool.",
